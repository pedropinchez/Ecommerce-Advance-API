...
class ItemController extends Controller
{
     ...
     *      @OA\Parameter(name="category", description="category, eg; 2,3,samsung", example="2,3", required=false, in="query", @OA\Schema(type="string")),
     *      @OA\Parameter(name="brand", description="brand, eg; 2", example="2,10,apple", required=false, in="query", @OA\Schema(type="string")),
     *      @OA\Parameter(name="min_price", description="min_price, eg; 2", example=20, required=false, in="query", @OA\Schema(type="string")),
     *      @OA\Parameter(name="max_price", description="max_price, eg; 2", example=20, required=false, in="query", @OA\Schema(type="string")),
     *      @OA\Parameter(name="rating", description="rating, eg; 4", example=4, required=false, in="query", @OA\Schema(type="string")),
     *      @OA\Parameter(name="paginate_no", description="paginate_no, eg; 2", example=20, required=false, in="query", @OA\Schema(type="string")),
     *      @OA\Parameter(name="attributes", description="attributes, eg; 12:12", example=20, required=false, in="query", @OA\Schema(type="string")),
     *      @OA\Parameter(name="type", description="All possible type items - eg: featured|best-sold|fastest-delivery", example="featured", required=false, in="query", @OA\Schema(type="string")),
